...
attrs = {'ruleFile': 'rules/typology/envelope.cgb',
         'startRule': 'Default$Lot', 'report_but_not_display_green': True}
attrs2 = {'ruleFile': 'rules/typology/envelope.cgb',
          'startRule': 'Default$Lot', 'report_but_not_display_green': False}
