...
class GeometryTest(unittest.TestCase):
    def test_verticesNber_candler(self):
        ...
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitReport' : False, 'emitGeometry' : True})
    ...
    def test_report_green(self):
        ...
        m = pyprt.ModelGenerator(shape_geo_from_obj)
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitReport' : True, 'emitGeometry' : False})
    ...
    def test_noReport(self):
        ...
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitReport' : False})
