...
class GeometryTest(unittest.TestCase):
    def test_verticesNber_candler(self):
        ...
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitReports' : False, 'emitGeometry' : True})
    ...
    def test_report_green(self):
        ...
        m = pyprt.ModelGenerator(shape_geo_from_obj)
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitReports' : True, 'emitGeometry' : False})
    ...
    def test_noReport(self):
        ...
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitReports' : False})
    ...
    def test_noGeometry(self):
        ...
        shape_geo = pyprt.Geometry([-10.0, 0.0, 5.0, -5.0, 0.0, 6.0, 20.0, 0.0, 5.0, 15.0, 0.0, 3.0])
        m = pyprt.ModelGenerator([shape_geo])
        model = m.generate_model(attrs, rpk, "com.esri.prt.examples.PyEncoder", {'emitGeometry' : False})
