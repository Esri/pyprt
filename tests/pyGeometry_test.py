...
class GeometryTest(unittest.TestCase):
    ...
    def test_report_green(self):
        ...
        ground_truth_dict = {'Number of trees_avg': 1.0, 'Number of trees_max': 1.0, 'Number of trees_min': 1.0,
                             ...
                             'green area_max': 1049.11, 'green area_min': 0.49, 'green area_n': 750.0,
                             'green area_sum': 2925.84, 'total report for optimisation_avg': 5.02,
                             'total report for optimisation_max': 1049.11, 'total report for optimisation_min': 0.49,
                             'total report for optimisation_n': 918.0, 'total report for optimisation_sum': 4605.84}
