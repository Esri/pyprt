...
setup(
    ...
    package_data={
        'pyprt' : [
            ...
            'bin/glutess.dll',
            'bin/glutess.lib',
            'bin/com.esri.prt.core.dll',
            'bin/com.esri.prt.core.lib',
            'lib/com.esri.prt.adaptors.dll',
            'lib/com.esri.prt.alembic.dll',
            'lib/com.esri.prt.codecs.dll',
            'lib/pyprt_codec.dll'
        ]
    },
